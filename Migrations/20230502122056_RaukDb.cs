        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationAndEvaluations_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "OrganizationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationAndEvaluations_Programs_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreviousApplications_ApplicationAndEvaluations_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "ApplicationAndEvaluations",
                        principalColumn: "ApplicationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PreviousApplications_ApplicationAndEvaluations_PreviousDnr",
                        column: x => x.PreviousDnr,
                        principalTable: "ApplicationAndEvaluations",
                        principalColumn: "ApplicationId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationAndEvaluations_OrganizationId",
                table: "ApplicationAndEvaluations",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationAndEvaluations_ProgramId",
                table: "ApplicationAndEvaluations",
                column: "ProgramId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreviousApplications_PreviousDnr",
                table: "PreviousApplications",
                column: "PreviousDnr");
